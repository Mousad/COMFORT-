        ...
        <section className="mx-auto max-w-[1400px] px-5 py-10 md:px-8 md:py-16">
          ...
          {items.length === 0 ? (
            <div className="flex min-h-[430px] flex-col items-center justify-center text-center">
              ...
              <Link
                href="/products"
                className="mt-7 bg-[#171717] px-8 py-4 text-xs text-white transition hover:bg-black/80"
              >
                اكتشف المنتجات
              </Link>
            </div>
            ...
            <div className="grid gap-10 lg:grid-cols-[1fr_380px]">
              ...
              <aside className="h-fit bg-white p-6 md:p-7 lg:sticky lg:top-28">
                ...
                <Link
                  href="/checkout"
                  className="mt-7 flex h-14 w-full items-center justify-center bg-[#171717] text-xs text-white transition hover:bg-black/80"
                >
                  إتمام الطلب
                </Link>
